...
fn main() {
    ...
    println!("\nThe {} is by the aspiration to train the Electrical/Electronic Engineering
        professionals in the areas of design, building and maintenance of electrical control
        systems,", n4);
    ...
    println!("{} is aimed at developing competent, creative, innovative, entrepreneurial
        and ethically-minded persons, capable of creating value in the diverse fields
        of Computer Science. ",w3);
    // Note: You cannot concatenate a string without the "&" behind the variable.
}
