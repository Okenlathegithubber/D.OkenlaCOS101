// Project to get area and volume of objects
...
fn main() 
{
    ...
    println!("Input 1 if to get the area of Trapezium");
    println!("Input 2 if to get the area of Rhombus");
    println!("Input 3 if to get the area of Parallelogram");
    println!("Input 4 if to get the area of Cube");
    println!("Input 5 if to get the volume of Cylinder");
