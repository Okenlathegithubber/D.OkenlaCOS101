...
fn main() 
{
    ...
    println!("Value at Index 0 = {} and {}", datatype_tuple.0, no_datatype_tuple.0);

    // accessing tuple element at index 1
    println!("Value at Index 1 = {} and {}", datatype_tuple.1, no_datatype_tuple.1);

    // accessing tuple element at index 2
    println!("Value at Index 2 = {} and {}", datatype_tuple.2, no_datatype_tuple.2);
}
